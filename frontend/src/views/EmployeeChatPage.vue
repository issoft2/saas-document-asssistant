      ...
      <aside
        ...
        <div class="flex-1 overflow-y-auto max-h-[60vh] lg:max-h-none p-2">
          <div v-for="conv in conversations" :key="conv.conversation_id"
            ...
            :class="conv.conversation_id === selectedConversationId
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="text-xs text-slate-500 mt-1 flex items-center gap-2">
                ...
                <div class="w-2 h-2 bg-emerald-400 rounded-full animate-pulse"
                  v-if="conv.conversation_id === selectedConversationId"></div>
              </div>
            </div>
            ...
            <button
              ...
              @click.stop="onDeleteConversation(conv.conversation_id)" title="Delete conversation">
      ...
      <main
        ...
        <div class="flex-1 flex flex-col min-h-0 overflow-hidden">
          ...
          <section v-if="messages && messages.length"
            ...
            <div v-for="(msg, idx) in messages" :key="msg.id" class="group space-y-4">
              <!-- User message -->
                ...
                <div
                  ...
                  <div v-if="editingMessageId === msg.id" class="space-y-3">
                    ...
                    <textarea v-model="editBuffer"
                      ...
                      rows="4" placeholder="Update your question and click Resend"></textarea>
                ...
                <div class="flex flex-col max-w-4xl w-full">
                  ...
                  <template v-if="isStreaming && idx === messages.length - 1">
                    <div
                      ...
                      <div class="w-3 h-3 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full animate-ping">
                      </div>
                  ...
                  <template v-else>
                    <div class="flex items-start gap-3 mb-3">
                      ...
                      <div class="flex-1 min-w-0 space-y-4">
                        <!-- Answer text -->
                        <MarkdownText v-if="msg.text" :content="msg.text"
                          class="prose prose-invert max-w-none text-slate-100 leading-relaxed answer-content" />

                        <!-- Charts -->
                        <div v-if="msg.chart_specs?.length" class="mt-2 pt-3 border-t border-slate-800/60 space-y-4">
                          <h4
                          ...
                          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <ChartRenderer v-for="(spec, i) in msg.chart_specs" :key="i" :spec="spec"
          ...
          <form @submit.prevent="onAsk" class="p-6 border-t border-slate-800/50 bg-slate-900/50 backdrop-blur-sm">
            <div class="flex items-end gap-3">
              <div class="flex-1 relative">
                ...
                <textarea v-model="question" :rows="question ? 3 : 1"
                  ...
                  :placeholder="messages && messages.length
                      ? 'Ask a follow-up or request a chart…'
                      : 'Ask about your policies or financials. Try “Compare Q1 2023 vs 2024 as charts”.'
                    " :disabled="isStreaming || loading" @keydown.enter.exact.prevent="handleEnter"></textarea>

                <!-- Suggestions -->
                <div v-if="suggestions && suggestions.length" class="mt-3 flex flex-wrap gap-2">
              ...
              <button type="submit" :disabled="isSubmitDisabled"
                ...
                <svg class="w-5 h-5 text-white group-hover:rotate-12 transition-transform duration-300" fill="none"
